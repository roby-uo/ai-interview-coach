...
##### `domain\job_configs\AI产品经理.yaml`

```yaml
job_type: "AI产品经理"
display_name: "AI产品经理"

domain_keywords: "LLM、RAG、Prompt Engineering、Agent、Fine-tuning、Token、向量数据库、知识图谱、模型评估、幻觉问题、多模态、AI伦理、MLOps、数据飞轮、用户意图、对话设计、AI-Native、模型选型、推理优化"

interviewer_persona: "你是一位经验丰富的AI产品经理面试官，擅长从AI产品思维和技术理解深度角度提炼面试核心要点。"

hr_persona: "你是一位阅人无数的资深AI行业HR，同时也是一位善于发现潜力的职业导师。"

gap_hr_persona: "你是一位资深的AI行业HR和职业规划师，专注于AI产品领域。"

mine_interviewer_persona: "你是一位经验丰富的AI产品经理面试官，擅长从AI产品思维和技术理解深度角度提炼面试核心要点。"

mine_hr_persona: "你是一位资深的AI产品经理 HR 兼教学设计师，现在你要根据一份教科书式的标准参考答案，逆向出一套用来帮助应届生系统提升面试能力的专业题库。"

default_jd: |
  岗位名称：AI产品经理
  岗位职责：
  1. 负责AI产品的需求分析、产品设计与落地推进
  2. 设计Prompt策略与RAG架构，优化大模型应用效果
  3. 搭建模型评估体系，持续追踪模型表现与用户体验
  4. 协调算法、工程、业务团队，推动AI产品从0到1落地
  5. 关注AI行业动态，探索新技术在业务场景中的应用
  任职要求：
  1. 1年以上AI产品经验，有大模型应用落地案例
  2. 理解LLM原理与局限性，具备Prompt Engineering能力
  3. 具备数据分析能力，能设计模型评估方案
  4. 有技术背景或B端产品经验优先
...
demo_resume: |
  ...
  教育背景：
  2019-2023 华中科技大学 计算机科学 本科

  工作经历：
  2023-2026 某AI科技公司 AI产品经理
  - 负责智能客服产品从0到1落地，基于RAG架构，准确率从65%提升至92%
  - 设计Prompt优化方案，减少模型幻觉率30%
  - 搭建模型评估体系，包含准确率、满意度、幻觉率等核心指标
  - 推动多模态功能上线，用户活跃度提升20%

  技能：
  AI产品设计、Prompt Engineering、RAG架构、模型评估、Python、SQL、数据分析

demo_jd: |
  岗位名称：资深AI产品经理
  岗位职责：
  1. 负责公司核心AI产品的战略规划与产品设计
  2. 带领3-5人产品小组，制定AI产品SOP和评估规范
  3. 统筹大模型应用架构设计，持续优化效果与成本
  4. 推动AI技术在多业务场景的落地与创新
  5. 关注AI前沿动态，制定技术路线图
  任职要求：
  1. 3年以上AI产品经验，有千万级用户AI产品案例
  2. 深度理解LLM技术原理与工程实践
  3. 具备强数据分析与实验设计能力
  4. 有团队管理经验，能搭建AI产品SOP
  5. 有大厂AI实验室或明星AI公司经验优先

```

##### `domain\job_configs\AI产品运营.yaml`

```yaml
job_type: "AI产品运营"
display_name: "AI产品运营"

domain_keywords: "AI运营、大模型运营、Prompt运营、AI用户增长、模型调优、数据标注、用户反馈闭环、AI效果评估、Token成本、幻觉治理、AI-Native运营、智能体运营、RAG运营、知识库运营、AI伦理合规、AI内容审核"

interviewer_persona: "你是一位经验丰富的AI产品运营面试官，擅长从AI产品运营和数据驱动角度提炼面试核心要点。"

hr_persona: "你是一位阅人无数的资深AI行业HR，同时也是一位善于发现潜力的职业导师。"

gap_hr_persona: "你是一位资深的AI行业HR和职业规划师，专注于AI产品运营领域。"

mine_interviewer_persona: "你是一位经验丰富的AI产品运营面试官，擅长从AI产品运营和数据驱动角度提炼面试核心要点。"

mine_hr_persona: "你是一位资深的AI产品运营 HR 兼教学设计师，现在你要根据一份教科书式的标准参考答案，逆向出一套用来帮助应届生系统提升面试能力的专业题库。"

default_jd: |
  岗位名称：AI产品运营
  岗位职责：
  1. 负责AI产品的日常运营与用户增长策略制定
  2. 搭建Prompt运营体系，持续优化模型输出质量
  3. 管理知识库与数据标注，保障RAG系统效果
  4. 建立用户反馈闭环，驱动模型迭代与产品优化
  5. 监控Token成本与模型效果，优化运营ROI
  任职要求：
  1. 1年以上AI产品运营经验，有大模型产品运营案例
  2. 理解大模型原理与局限性，具备Prompt优化能力
  3. 具备数据分析能力，能独立完成运营复盘
  4. 有AI内容审核或知识库运营经验优先
...
demo_resume: |
  ...
  教育背景：
  2019-2023 厦门大学 信息管理 本科

  工作经历：
  2023-2026 某AI公司 AI产品运营
  - 负责AI写作助手产品运营，月活用户从5万增长至30万
  - 搭建Prompt模板库，覆盖50+场景，用户满意度提升35%
  - 建立用户反馈闭环体系，每月驱动3-5次模型迭代
  - 优化Token使用策略，单用户成本降低50%

  技能：
  AI产品运营、Prompt优化、数据分析、知识库管理、SQL、用户增长、内容运营

demo_jd: |
  岗位名称：资深AI产品运营
  岗位职责：
  1. 负责公司核心AI产品的运营体系搭建与策略制定
  2. 带领3-5人运营小组，制定AI运营SOP和评估规范
  3. 统筹Prompt运营与知识库管理，持续优化模型效果
  4. 搭建AI产品增长飞轮，驱动用户规模与留存提升
  5. 关注AI行业动态，探索新运营模式与创新场景
  任职要求：
  1. 3年以上AI产品运营经验，有百万级用户AI产品案例
  2. 深度理解大模型技术原理与运营实践
  3. 具备强数据分析与实验设计能力
  4. 有团队管理经验，能搭建AI运营SOP
  5. 有大厂或明星AI公司经验优先
...
##### `domain\job_configs\用户增长运营.yaml`

```yaml
job_type: "用户增长运营"
display_name: "用户增长运营"

domain_keywords: "AARRR、北极星指标、增长黑客、裂变、获客成本CAC、LTV、留存率、DAU/MAU、漏斗转化、AB测试、用户画像、渠道归因、Referral、激活率、触达率、RFM模型、冷启动、增长实验、数据驱动"

interviewer_persona: "你是一位经验丰富的用户增长运营面试官兼数据分析师，擅长从增长实战和数据驱动角度提炼面试核心要点。"

hr_persona: "你是一位阅人无数的资深互联网行业HR，同时也是一位善于发现潜力的职业导师。"

gap_hr_persona: "你是一位资深的互联网行业HR和职业规划师，专注于用户增长领域。"

mine_interviewer_persona: "你是一位经验丰富的用户增长运营面试官兼数据分析师，擅长从增长实战和数据驱动角度提炼面试核心要点。"

mine_hr_persona: "你是一位资深的用户增长运营 HR 兼教学设计师，现在你要根据一份教科书式的标准参考答案，逆向出一套用来帮助应届生系统提升面试能力的专业题库。"

default_jd: |
  岗位名称：用户增长运营
  岗位职责：
  1. 负责产品用户增长策略制定与执行，提升获客效率与规模
  2. 搭建并优化AARRR漏斗模型，提升各环节转化率
  3. 设计并执行增长实验（A/B测试），以数据驱动决策
  4. 管理多渠道获客投放，优化CAC与ROI
  5. 搭建裂变与Referral体系，驱动用户自传播
  任职要求：
  1. 1年以上用户增长/运营经验，有增长操盘案例
  2. 熟悉增长黑客方法论，具备数据驱动思维
  3. 具备数据分析能力，能独立设计并分析A/B测试
  4. 有从0到1冷启动或大规模增长经验优先
...
demo_resume: |
  ...
  教育背景：
  2019-2023 中山大学 统计学 本科

  工作经历：
  2023-2026 某互联网公司 用户增长运营
  - 负责App用户增长策略，DAU从10万提升至50万
  - 设计裂变活动，单次活动带来5万新增用户，获客成本降低40%
  - 搭建A/B测试体系，累计完成50+组实验，核心转化率提升25%
  - 优化渠道投放策略，ROI从1.5提升至3.2

  技能：
  增长策略、数据分析、A/B测试、SQL、Python、渠道投放、裂变运营

demo_jd: |
  岗位名称：资深用户增长运营
  岗位职责：
  1. 负责公司核心产品的用户增长体系搭建与策略制定
  2. 带领3-5人增长小组，制定增长SOP和实验规范
  3. 统筹全渠道获客策略，持续优化CAC与LTV
  4. 搭建北极星指标体系，推动跨部门增长协作
  5. 探索创新增长模式，驱动产品破圈与用户自传播
  任职要求：
  1. 3年以上用户增长经验，有千万级DAU产品增长案例
  2. 深度理解增长黑客方法论与数据驱动决策
  3. 具备强数据分析与实验设计能力
  4. 有团队管理经验，能搭建增长SOP
  5. 有大厂或明星创业公司经验优先
...
domain_keywords: "GMV、转化率、客单价、复购率、UV、ROI、直通车、引力魔方、万相台、坑产、动销率、库存周转、选品、爆品、私域运营、会员体系、大促策划、供应链、售后指标、DSR评分"

interviewer_persona: "你是一位经验丰富的电商运营面试官兼数据分析专家，擅长从实战角度提炼面试核心要点。"

hr_persona: "你是一位阅人无数的资深电商行业HR，同时也是一位善于发现潜力的职业导师。"

gap_hr_persona: "你是一位资深的电商行业HR和职业规划师。"

mine_interviewer_persona: "你是一位经验丰富的电商运营面试官兼数据分析专家，擅长从实战角度提炼面试核心要点。"

mine_hr_persona: "你是一位资深的电商运营 HR 兼教学设计师，现在你要根据一份教科书式的标准参考答案，逆向出一套用来帮助应届生系统提升面试能力的专业题库。"

default_jd: |
  岗位名称：电商运营
  岗位职责：
  1. 负责店铺整体运营规划，制定并执行销售策略，完成GMV目标
  2. 负责直通车、引力魔方等付费推广工具的投放与优化，提升ROI
  3. 策划并执行大促活动（618、双11等），制定活动方案及节奏
  4. 分析店铺数据（流量、转化、客单价等），输出运营复盘报告
  5. 跟进选品与供应链协调，优化库存周转与动销率
  任职要求：
  1. 1年以上电商运营经验，有淘宝/天猫/京东/拼多多操盘经验
  2. 熟悉各电商平台规则与算法机制
  3. 具备数据分析能力，能独立完成运营复盘
  4. 有大促活动策划经验优先
...
demo_resume: |
  ...
  教育背景：
  2019-2023 浙江大学 电子商务 本科

  工作经历：
  2023-2026 某品牌电商公司 电商运营专员
  - 负责天猫旗舰店日常运营，年GMV从200万提升至800万
  - 策划双11大促活动，单日GMV突破150万，同比增长120%
  - 优化直通车投放策略，ROI从1.8提升至3.5
  - 搭建店铺会员体系，复购率提升15%

  技能：
  天猫运营、直通车投放、数据分析、活动策划、选品、Excel、生意参谋

demo_jd: |
  岗位名称：资深电商运营
  岗位职责：
  1. 负责品牌天猫/京东旗舰店整体运营规划，制定年度GMV目标与拆解
  2. 统筹付费推广投放策略，持续优化ROI与获客成本
  3. 带领3-5人运营小组，制定运营SOP和培训体系
  4. 主导大促活动全链路策划与执行，协同供应链保障交付
  5. 搭建私域运营体系，提升会员复购与LTV
  任职要求：
  1. 3年以上电商运营经验，有类目TOP店铺操盘案例
  2. 深度理解电商平台算法与流量分配逻辑
  3. 具备强数据分析能力，能独立完成经营分析报告
  4. 有团队管理经验，能搭建运营SOP
  5. 有品牌方或TP公司经验优先
...
#### `deploy\coze_plugin.yaml`

```yaml
openapi: "3.0.0"
info:
  title: AI面试教练
  description: 专属AI面试教练，提供模拟面试训练、弱点画像、差距分析和能力报告
  version: "1.0.0"
...
paths:
  /api/interview:
    post:
      ...
      summary: 面试教练对话
      description: |
        发送用户消息或执行操作。每次用户发消息都必须调用此工具。
        如果返回status为processing，请用task_id调用pollTask轮询结果。
      requestBody:
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                user_id:
                  type: string
                  description: "用户唯一标识，使用 {{conversation_id}}"
                message:
                  type: string
                  description: "用户消息原文"
                  default: ""
                action:
                  ...
                  enum:
                    ...
                    - reset
                    - use_default_jd
                  description: "操作类型，默认chat"
                  default: chat
                job_type:
                  type: string
                  description: "岗位类型，选择岗位时必填。可用listJobs查询"
                file_url:
                  type: string
                  description: "用户上传文件的URL"
      responses:
        "200":
          description: 面试教练响应
          content:
                  ...
                  actions:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        action:
                          type: string
                          description: "按钮对应的action值"
                        value:
                          type: string
                          description: "附加参数"
                  status:
                    type: string
                    description: "状态：ok/processing/waiting/error"
                  task_id:
                    type: string
                    description: "processing时返回，用于轮询"

  /api/interview/{task_id}:
    get:
      operationId: pollTask
      summary: 轮询异步任务结果
      description: |
        当interviewChat返回status为processing时，用此接口轮询。
        每隔3-5秒调用一次，直到status变为ok或error。
        如果结果为ok，将reply原样展示给用户。
      parameters:
        - name: task_id
          in: path
          required: true
  ...
  /api/jobs:
    get:
      ...
      summary: 获取可用岗位列表
      description: 查询当前系统支持的所有岗位类型及显示名称
      responses:
        "200":
          description: 岗位列表
          content:
